...
def g8536_1(dtInicio, dtFinal):
    print("\n > Iniciando 8536 Loja 1")
    time.sleep(5)
...
def e8536_1(dtInicio, dtFinal):
    ...
    time.sleep(5)
    pyautogui.hotkey('alt', 'f')
    print("     - Finalizado rotina 8536 Loja 1")
