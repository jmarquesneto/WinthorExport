...
def g8796(dtInicio, dtFinal):
    print("\n > Iniciando 8796 Loja 1")
    time.sleep(5)

    pyautogui.write('8796')
...
def e8796(dtInicio, dtFinal):
    print("     - Aguardando geração do relatório 8796 Loja 1...")
    ...
    pyautogui.keyUp('alt')
    time.sleep(10)
    pyautogui.write(f'8796 - {dtFormatada}')
    pyautogui.press('enter')
    time.sleep(10)
